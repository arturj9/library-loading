...
export function Cabecalho() {
    ...
    return (
        <div className="h-16 p-1 text-slate-600 bg-white flex justify-between shadow-md">
            ...
            <div className="w-24 flex justify-between items-center">
                <button onClick={handle} className="p-1 text-slate-100 bg-lime-500 rounded-2xl">ADMIN</button>
